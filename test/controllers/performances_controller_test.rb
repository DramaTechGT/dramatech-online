...
class PerformancesControllerTest < ActionController::TestCase
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post :create, performance: { end_time: @performance.end_time, location: @performance.location, show: @performance.show, start_time: @performance.start_time }
    end
  ...
  test "should update performance" do
    patch :update, id: @performance, performance: { end_time: @performance.end_time, location: @performance.location, show: @performance.show, start_time: @performance.start_time }
    assert_redirected_to performance_path(assigns(:performance))
  end
